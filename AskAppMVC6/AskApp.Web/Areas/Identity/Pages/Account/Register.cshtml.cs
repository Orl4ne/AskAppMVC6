...
namespace AskApp.Web.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            UserManager<AskAppIdentityUser> userManager,
            SignInManager<AskAppIdentityUser> signInManager,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new AskAppIdentityUser { UserName = Input.UserName, Email = Input.Email };
